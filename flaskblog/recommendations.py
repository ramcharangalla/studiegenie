...
users_interactions_count_df = None
users_with_enough_interactions_df = None
interactions_from_selected_users_df = None
interactions_full_df = None
interactions_full_indexed_df = None
def init_df(notes_dff,interactions_dff):
  notes_df = notes_dff
  interactions_df = interactions_dff
  print('intialized dfs')

  if notes_df is not None:
    print('INITIALIZED DFS')
    ...
    users_with_enough_interactions_df = users_interactions_count_df[users_interactions_count_df >= 2].reset_index()[[interactions_userid]]
